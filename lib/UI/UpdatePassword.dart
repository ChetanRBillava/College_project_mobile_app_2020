import 'package:mitk_final_year_project_2020/API/UpdatePasswordAPI.dart';
...
class _UpdatePasswordState extends State<UpdatePassword> {
  ...
  void validateAndSave() {
    ...
    if (form.validate()) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => UpdatePasswordAPI()),
      );
    }
    else {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            HeadingText(titleText: 'Update Password', colorUsed: Colors.black),
                          ],
                        ),
                        SizedBox(height: MediaQuery.of(context).size.height*0.05,),
                        //Old Password
